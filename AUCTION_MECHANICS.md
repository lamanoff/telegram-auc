...
### 9.3 Не реализовано (потенциальные улучшения)

1. **Частичные возвраты** — при отмене аукциона все средства возвращаются полностью
2. **Комиссии** — в текущей версии комиссии не взимаются
3. **Резервирование товаров** — товары резервируются только при выигрыше, не заранее
4. **Множественные валюты** — один аукцион = одна валюта
